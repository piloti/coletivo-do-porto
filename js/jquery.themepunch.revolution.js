										   ...
										   var imh = 0;
											...
											nextcaption.data('timer',setTimeout(function() {
														...
														)
													{
														...
														nextcaption.data('repo',nextcaption.css('opacity'));
														var tamanhoContainer = po.width();
														nextcaption.animate({marginLeft: "-50%", position: 'absolute', 'opacity':1,left:'50%','top':opt.bh*(nextcaption.data('y'))+"px"},{duration:nextcaption.data('speed'), easing:easetype,complete:function() { if (opt.ie) $(this).addClass('noFilterClass');}});
														//if (opt.ie) nextcaption.addClass('noFilterClass');
													}
													if (nextcaption.hasClass('centralizarY')){
														var tamanhoContainer = po.width();
														var positionY;
														if (tamanhoContainer <= 385){
															positionY = 30;
														}else if (tamanhoContainer <= 1024 && tamanhoContainer > 385 ){
															positionY = 130;
														}else{
															positionY = 140;
														}
														...
														nextcaption.data('repo',nextcaption.css('opacity'));
														var tamanhoContainer = po.width();
														nextcaption.animate({marginLeft: "-50%", position: 'absolute', 'opacity':1,left:'50%','top':positionY+"px"},{duration:nextcaption.data('speed'), easing:easetype,complete:function() { if (opt.ie) $(this).addClass('noFilterClass');}});
														//if (opt.ie) nextcaption.addClass('noFilterClass');
													}
